...
<div class="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="footer-newsletter">
                            <h2>¿Qué hacemos?</h2>
                            <p>
                            Software chemical es una sistema de información en donde podras crear un inventario de los productos quimicos almacenados en tu empresa.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container copyright">
                    <div class="col-md-6">
                        <p>Realizado por <a href="https://anacastanod.com">anacastanod</a></p>
                    </div>
                </div>
            </div>
        </div>
